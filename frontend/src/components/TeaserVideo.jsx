...
const TeaserVideo = () => {
  ...
  // Safer video loading without direct DOM manipulation
    ...
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div 
        ...
        style={{
          ...
          filter: videoLoaded ? 'opacity(0.3)' : 'opacity(1)',
          transition: 'opacity 1s ease-in-out'
        }}
      />
      
      {/* YouTube Video Embed - SAFER VERSION */}
      {!videoError && (
        <iframe
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-transparent to-black/40 flex items-center justify-center">
        <div className="text-center text-white z-10 max-w-4xl px-6">
          ...
          <button 
            onClick={() => {
              try {
                // Safer scrolling without DOM queries
                window.scrollTo({
