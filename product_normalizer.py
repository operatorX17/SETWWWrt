...
class OGProductNormalizer:
    ...
    def create_product_object(self, base_id: int, product_data: Dict) -> Dict:
        ...
        return {
            ...
            'images': [
                f"https://imgreveal.preview.emergentagent.com/products/{category.lower()}/{concept}/front/main.jpg",
                f"https://imgreveal.preview.emergentagent.com/products/{category.lower()}/{concept}/back/main.jpg"
            ],
